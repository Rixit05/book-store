		...
		<main class="inner-page-sec-padding-bottom">
			...
			<div class="shop-toolbar mb--30">
				...
				if($_GET['Category'])
				{
					...
					$sql="select * from book_details where Genre1='$keyword' or Genre2='$keyword' or Genre3='$keyword' or Genre4='$keyword' or Genre5='$keyword'";
					$data=mysqli_query($con,$sql);
				}
				else if($_GET['Keyword'])
				{
					$keyword=$_GET['Keyword'];
					$sql="select * from book_details where Title like '%$keyword%'";
					$data=mysqli_query($con,$sql);	
				}
				else
				{
					...
					<div class="col-md-12">
						<div class="pagination-block">
							<ul class="pagination-btns flex-center">
								...
								{
									echo '
									<li><a href="search-books.php?'.$key.$cat.'page=1" class="single-btn prev-btn ">|<i class="zmdi zmdi-chevron-left"></i> </a>
									</li>
									';
									echo '<li><a href="search-books.php?'.$key.$cat.'page='.($page-1).'" class="single-btn prev-btn "><i class="zmdi zmdi-chevron-left"></i> </a>
									</li>';
									echo '<li><a href="search-books.php?'.$key.$cat.'page='.($page-1).'" class="single-btn">'.($page-1).'</a></li>';
									if($page==ceil($total/12))
									{
										echo '<li class="active"><a href="search-books.php?'.$key.$cat.'page='.($page).'" class="single-btn">'.($page).'</a></li>';
									}
								}
								if($page<$total/12)
								{
									echo '<li class="active"><a href="search-books.php?'.$key.$cat.'page='.$page.'" class="single-btn">'.$page.'</a></li>';
									echo '<li><a href="search-books.php?'.$key.$cat.'page='.($page+1).'" class="single-btn">'.($page+1).'</a></li>';
									echo '<li><a href="search-books.php?'.$key.$cat.'page='.($page+1).'" class="single-btn next-btn"><i class="zmdi zmdi-chevron-right"></i></a>
									</li>';
									echo '
									<li><a href="search-books.php?'.$key.$cat.'page='.(ceil($total/12)).'" class="single-btn next-btn"><i class="zmdi zmdi-chevron-right"></i>|</a>
									</li>
									';
								}
								?>
