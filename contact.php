                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contact_form">
                            ...
                            <form id="contact-form" action="send-message.php" method="post" class="contact-form">
                                <div class="row">
                                    <div class="col-lg-12">
                            ...
                            <div class="form-output">
                                ...
                                <?php
                                                    if($_GET['res'])
                                                    {
                                                        echo '<p class="form-messege" style="color:blue;text-align:center;"><b>'.$_GET['res'].'</b></p>';
                                                    }
                                                ?>
                            </div>
                        </div>
