									...
									<div id="billing-form" class="mb-40">
										...
										<div class="row">
											...
											<div class="col-md-6 col-12 mb--20">
												...
												<input type="text" placeholder="Phone number" id="phone" required name="Phone">
											</div>
											<div class="col-md-6 col-12 mb--20">
												<label for="pin">Pin Code*</label>
												<input type="number" placeholder="Pin Code" maxlength="6" id="pin" required name="Pin">
											</div>
											<div class="order-note-block mb--20 col-md-12 col-12">
												<label for="address">Address*</label>
												<textarea id="order-note" cols="30" rows="10" class="order-note"
												placeholder="Address(Area/Street)" id="address" required name="Address"></textarea>
											</div>
											<div class="col-md-6 col-12 mb--20">
												<label for="town">Town/City*</label>
												<input type="text" placeholder="Town/City" id="town" required name="Town">
											</div>
											<div class="col-md-6 col-12 mb--20">
												<label for="state">State*</label>
												<input type="text" placeholder="State" id="state" required name="State">
											</div>
											<div class="col-12 mb--20 ">
												<div class="block-border check-bx-wrapper">
													<div class="check-box">
														<input type="checkbox" id="shiping_address" data-shipping name="Check">
									...
									<div id="shipping-form" class="mb--40">
										...
										<div class="row">
											<div class="col-md-12 col-12 mb--20">
												...
												<input type="text" placeholder="Full Name" id="name1"   name="Name1">
											</div>
											<div class="col-md-6 col-12 mb--20">
												<label for="phone1">Phone no*</label>
												<input type="text" placeholder="Phone number" id="phone1"  name="Phone1">
											</div>
											<div class="col-md-6 col-12 mb--20">
												<label for="pin1">Pin Code*</label>
												<input type="number" placeholder="Pin Code" maxlength="6" id="pin1"  name="Pin1">
											</div>
											<div class="order-note-block mb--20 col-md-12 col-12">
												<label for="address1">Address*</label>
												<textarea id="order-note" cols="30" rows="10" class="order-note"
												placeholder="Address(Area/Street)" id="address1"  name="Address1"></textarea>
											</div>
											<div class="col-md-6 col-12 mb--20">
												<label for="town1">Town/City*</label>
												<input type="text" placeholder="Town/City" id="town1"  name="Town1">
											</div>
											<div class="col-md-6 col-12 mb--20">
												<label for="state1">State*</label>
												<input type="text" placeholder="State" id="state1"  name="State1">
											</div>
										</div>
									</div>
								</div>
										...
										<div class="col-12">
											<div class="checkout-cart-total">
												<?php
													...
													<ul>
													';
													$sql="select * from cart_details where User_id='$_SESSION[user_id]'";
													$data=mysqli_query($con,$sql);
													$total=0;
													while($result=mysqli_fetch_array($data))
													{
														$book_id=$result['Book_id'];
														$sql1="select * from Book_details where Book_id='$book_id'";
														$data1=mysqli_query($con,$sql1);
														$result1=mysqli_fetch_array($data1);
														$total+=($result1['Price']-($result1['Discount']*$result1['Price'])/100)*$result['Quantity'];
														echo '
														<li>
															<span class="left">'.$result1['Title'].' X '.$result['Quantity'].'</span> 
															<span class="right">'.($result1['Price']-($result1['Discount']*$result1['Price'])/100)*$result['Quantity'].'</span>
														</li>
														';
													}
													if($total<500)
													...
													<p>Shipping Fee <span>'.$shipping_charge.'</span></p>
													<h4>Grand Total <span>'.$total+$shipping_charge.'</span></h4>
													<br>
...
===================================== -->
	...
	<script>
		function check()
		{
			...
			{
				if(document.getElementById("name1").value && document.getElementById("phone1").value && document.getElementById("pin1").value && document.getElementById("address1").value && document.getElementById("town1").value && document.getElementById("state1").value)
				{
					return true;
				}
				else
