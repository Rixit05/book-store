...
<body>
	<div class="site-wrapper" id="top">
        ...
        <?php
            $User_id=$_SESSION['user_id'];
            $sql="select * from order_header where User_id='$User_id'";
            ...
            $sql4="select * from order_header where Order_id='$id'";
            $data4=mysqli_query($con,$sql4);
            $result=mysqli_fetch_array($data4);
            echo'
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <ul class="order-details-list">
                                <li>Order Number: <strong>'.$result['Order_id'].'</strong></li>
                                <li>Date: <strong>'.$result['Order_date'].'</strong></li>
