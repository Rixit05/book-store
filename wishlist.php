							...
							<div class="cart-table table-responsive">
								<table class="table">
									...
									<tbody>
                                        <?php
                                            include "connect.php";
                                            $sql1="select * from wishlist_details where User_id=$_SESSION[user_id]";
                                            ...
                                            if(mysqli_num_rows($data))
                                            {
                                                while($result=mysqli_fetch_array($data))
                                                {
                                                    ...
                                                    echo '
                                                    <tr>
                                                        <td class="pro-thumbnail"><a href="product-details.php?Id='.$result['Book_id'].'"><img
                                                                    src="image/products/'.$result1['Image'].'" alt="'.$result1['Title'].'"></a></td>
                                                        <td class="pro-title"><a href="product-details.php?Id='.$result['Book_id'].'">'.$result1['Title'].'</a></td>
                                                        <td class="pro-price"><span>'.$result1['Price'].'</span></td>
                                                        <td class="pro-discount"><span>'.$result1['Discount'].'</span></td>
                                                        <td class="pro-subtotal"><span>'.($result1['Price']-($result1['Discount']*$result1['Price'])/100).'</span></td>
                                                        <td class="pro-remove"><a href="remove-from-wishlist.php?User_id='.$result['User_id'].'&Book_id='.$result['Book_id'].'"><i class="far fa-trash-alt"></i></a></td>
                                                    </tr>
                                                    ';
                                                }
                                            }
