				...
				<div class="container">
					<?php
						...
						if(mysqli_num_rows($data))
						{
							...
							{
								$sql2="select * from book_details where Book_id='$result[Book_id]'";
								$data1=mysqli_query($con,$sql2);
								$result1=mysqli_fetch_array($data1);
								$price=($result1['Price']-($result1['Discount']*$result1['Price'])/100);
								echo '
								<tr>
									<form action="update-cart.php" method="post">
									<input type="hidden" value="'.$result['Book_id'].'" name="book_id">
									<td class="pro-thumbnail"><a href="#">
										<img src="image/products/'.$result1['Image'].'" alt="Product"></a>
									</td>
									<td class="pro-title"><a href="#">'.$result1['Title'].'</a></td>
									<td class="pro-price"><span>'.$price.'</span></td>
									<td class="pro-quantity">
										<div class="pro-qty">
											<div class="count-input-block">
												<input type="number" class="form-control text-center" value="'.$result['Quantity'].'" name="Quantity">
											</div>
										</div>
									</td>
									<td class="pro-subtotal"><span>'.$result['Quantity']*$price.'</span></td>
									<td class="pro-remove">
										<a href="remove-from-cart.php?Book_id='.$result1['Book_id'].'"><i class="far fa-trash-alt"></i></a>
										<button type="submit"><a><i class="fa fa-save"></i></a></button>
									</td>
                                    </form>
								</tr>
								';
								$total+=$result['Quantity']*$price;
							}
							if($total>=500)
							{
								$ship_charge=0;
											...
											<div class="col-lg-6 col-12 d-flex">
												<div class="cart-summary">
													<div class="cart-summary-wrap">
														...
														<p>Shipping Cost <span class="text-primary">&#8377;'.$ship_charge.'</span></p>
														<h2>Grand Total <span class="text-primary">&#8377;'.$total+$ship_charge.'</span></h2>
													</div>
